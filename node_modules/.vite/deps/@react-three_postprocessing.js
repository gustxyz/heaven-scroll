...
var wrapEffect = (effect, defaults) => import_react.default.forwardRef(function Effect2({ blendFunction = defaults === null || defaults === void 0 ? void 0 : defaults.blendFunction, opacity = defaults === null || defaults === void 0 ? void 0 : defaults.opacity, ...props }, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(Component, { camera, "blendMode-blendFunction": blendFunction, "blendMode-opacity": opacity, ...props, ref, args });
});
...
var Autofocus = (0, import_react.forwardRef)(({ target = void 0, mouse: followMouse = false, debug = void 0, manual = false, smoothTime = 0, ...props }, fref) => {
  ...
  (0, import_react.useImperativeHandle)(fref, () => ({
    dofRef,
    hitpoint,
    update
  }), [hitpoint, update]);
