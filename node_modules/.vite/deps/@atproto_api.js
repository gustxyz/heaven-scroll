...
`;
    ...
    var ResponseType = ((ResponseType2) => {
    ...
    var AdminNS = class {
      ...
      resolveModerationReports(data, opts) {
        return this._service.xrpc.call("com.atproto.admin.resolveModerationReports", opts == null ? void 0 : opts.qp, data, opts).catch((e) => {
          throw toKnownErr9(e);
        });
      }
      reverseModerationAction(data, opts) {
        return this._service.xrpc.call("com.atproto.admin.reverseModerationAction", opts == null ? void 0 : opts.qp, data, opts).catch((e) => {
      ...
      takeModerationAction(data, opts) {
        return this._service.xrpc.call("com.atproto.admin.takeModerationAction", opts == null ? void 0 : opts.qp, data, opts).catch((e) => {
...
//# sourceMappingURL=@atproto_api.js.map
